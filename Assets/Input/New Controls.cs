...
public class @NewControls : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Gameplay"",
            ""id"": ""5bba7004-1144-4a02-9489-b0fcb32f2b07"",
            ""actions"": [
                {
                    ""name"": ""Movement"",
                    ""type"": ""Value"",
                    ""id"": ""30072d6f-2f22-4386-892f-809ad39b0644"",
                ...
                },
                {
                    ""name"": ""Altitude"",
                    ""type"": ""Value"",
                    ""id"": ""b5d3f752-f05f-4377-85d8-75e853cee29b"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""50bab663-faf2-40b3-bed1-ccc97d1a3e22"",
                ...
                {
                    ""name"": ""Wasd"",
                    ""id"": ""e6e4d0fd-79c3-4a64-b190-5923e88314cd"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""fba502ee-749a-4b1e-9004-f430896adb1d"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""e3790e72-a006-47af-a749-d191c376db10"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""60ab5294-a8b8-415d-ad5e-ac9ad3a0ac57"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""95977eb9-4d01-4e5e-aae0-fbfba9803f31"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": ""UpDown Gamepad"",
                    ""id"": ""243e11bd-7866-4497-b528-3e554d491656"",
                    ""path"": ""1DAxis"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""negative"",
                    ""id"": ""876a9578-4748-41eb-aad2-7358fdfa812a"",
                ...
                {
                    ""name"": ""positive"",
                    ""id"": ""fc20d5e2-5370-419b-8f48-b83f03690fab"",
                ...
                {
                    ""name"": ""1D Axis"",
                    ""id"": ""19951c46-8465-4897-bfdf-c65b7d985f64"",
                    ""path"": ""1DAxis"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""negative"",
                    ""id"": ""10bc4b92-8e8a-4ded-aacc-c33340de6534"",
                    ""path"": ""<Keyboard>/x"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": ""positive"",
                    ""id"": ""4a3774ee-5729-4730-b540-2fa5b3da612e"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
